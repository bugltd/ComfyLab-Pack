...
export function DebugJSONYAML(nodeType) {
    ...
    nodeType.prototype.onNodeCreated = function (...args) {
        ...
        loadButtonWidget.callback = async () => {
            ...
            const loaded = await loadTextFile('.json,.yaml,.yml,application/JSON,application/yaml');
            if (loaded) {
                ...
                try {
                    ...
                    parsedTypeWidget.value = e.message;
                    contentWidget.value = '';
                }
            }
...
export function DebugWidgetVisibility(nodeType) {
    const original_onNodeCreated = nodeType.prototype.onNodeCreated;
    nodeType.prototype.onNodeCreated = function (...args) {
        original_onNodeCreated?.apply(this, ...args);
        ...
        const switchWidget = makeSwitchWidget(this, 'switch', [multi1Widget, text1Widget], [text2Widget, multi2Widget]);
